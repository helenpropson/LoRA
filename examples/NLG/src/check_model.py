...
train_data = FT_Dataset(
    "LoRA/examples/NLG/data/e2e/train.jsonl", 8, 512, 
    joint_lm="clm"=='jlm'
)     
...
# lm_net.load_weight(torch.load("LoRA/examples/NLG/pretrained_checkpoints/gpt2-pytorch_model.bin"))
lm_net.load_weight(torch.load('LoRA/examples/NLG/trained_models/GPT2_S_LL/e2e/model.26290.pt'))
